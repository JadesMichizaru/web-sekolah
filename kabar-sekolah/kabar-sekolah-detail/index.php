							...
							<div id="content">
								...
								<section class="blog">
									<article class="hold-line more">
										<div class="blog-head">
											...
											<div class="box">
												<div class="row">
													<div class="col-xs-12">
														<span class="text-posted">Diposting oleh <i class="fa-icon-user"></i> <a href="#">A</a> | <i class="fa-icon-comment"></i> <a href="#komentar" class="text-comments">5 Komentar</a></span>
													</div>
												</div>
											</div>
										</div>
										...
										<figure class="wrap-img"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0ppZQhvTUSCrN3xgNK3dSzv0Qi7y_4P43cGQehzbE_h321UFJYh1SwkbHONdtZti0B4E&usqp=CAU" alt="image" /></figure>
									...
									<div class="box-author">
										<a href="http://www.birohmatika.com/alif" target="_blank">
											<span class="hold-img pull-left"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0ppZQhvTUSCrN3xgNK3dSzv0Qi7y_4P43cGQehzbE_h321UFJYh1SwkbHONdtZti0B4E&usqp=CAU" alt="image" width="100" height="102" /></span>
											<strong class="title">Muhammad Alif Akbar Fachrul Azizi</strong>
										</a>
										<span class="text-author">Administrator</a></span>
										<p>Harus Tetap Berusaha Mendapatkannya walaupun ia tidak pernah menghiraukanmu</p>
									...
									<div class="comments" id="komentar">
										...
										<div class="hold-comments">
											<div class="box">
												<figure class="hold-img pull-left"><a href="#"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0ppZQhvTUSCrN3xgNK3dSzv0Qi7y_4P43cGQehzbE_h321UFJYh1SwkbHONdtZti0B4E&usqp=CAU" alt="image" width="80" height="82" /></a></figure>
												<ul class="topiclist list-inline">
													<li>
														<small>
															Komentar oleh <a href="#">Anonim</a> tanggal 3 April 2023, 11:59 AM
														</small>
													</li>
													<li>
												...
												<p> Apapun Yang Terjadi, Terjadilah </p>
											</div>
										</div>
										<div class="hold-comments">
											<div class="box">
												...
												<ul class="topiclist list-inline">
													<li>
														<small>
															Komentar oleh <a href="#">Anonim</a> tanggal 4 april 2023, 13:00 PM
														</small>
													</li>
													<li>
														<a class="link" href="#">Balas</a>
								...
								<section class="popular-posts">
									...
									<div class="box-address">
										...
										<address>
											<ul class="contacts">
												<li>Alamat Admin</li>
												<li>Jl. Jatinegara Bar. No.15, RW.3, Kampung Pulo, Kecamatan Jatinegara, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13320</li>
												<li>Phone : +62 0812-8867-7669</li>
												<li>Fax : ??</li>
												<li>E-Mail: <a href="mailto:alifakbar702@yahoo.com">alifakbar702@yahoo.com</a></li>
											</ul>
										</address>
									</div>
