...
<html lang="id">
	<head>
		...
		<!-- Informasi Umum -->
		<title>Nama Sekolah | Official Website</title>
									...
									<div class="frame pull-right">
										...
										<div class="profiles-box pull-right active">
											...
											<ul class="tools tools-middle pull-left">
												<li><a href="javascript:;" target="_blank"><span class="fa-icon-facebook-sign"></span></a></li>
												<li><a href="javascript:;" target="_blank"><span class="fa-icon-twitter"></span></a></li>
												<li><a href="javascript:;" target="_blank"><span class="fa-icon-google-plus"></span></a></li>
											</ul>
										</div>
									</div>
								</div>
											...
											<nav class="navbar navbar-default navbar-business" role="navigation">
												...
												<div class="collapse navbar-collapse">
													...
													<ul class="nav navbar-nav">
														...
														<li class="active dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">Profil Sekolah</a>
														...
														<li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">Kesiswaan</a>
														    <ul class="dropdown-menu">
