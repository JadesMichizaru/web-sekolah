...
<html lang="id">
	<head>
		...
		<!-- Informasi Umum -->
		<title>Nama Sekolah Official Web - Galeri</title>
							...
							<div id="content">
								...
								<div class="wrap-space">
									<ul class="pagination pagination-lg pagination-business">
										<li class="prev"><a href="javascript:;">«</a></li><li class="active">
											<a href="#">1</a></li><li>
											<a href="#">2</a></li><li>
											<a href="#">3</a></li><li>
											<a href="#">4</a></li><li>
						...
						<div class="col-md-3 col-sm-4">
							...
							<aside id="sidebar" class="more" style="background:white">
								<div class="hold-line">
									...
									<ul class="list">
										<li>
											<a href="404.html">Lanji</a>
											<span class="number">(8)</span>
										</li>
										<li>
											<a href="404.html">Kelas</a>
											<span class="number">(10)</span>
										</li>
										<li>
											<a href="404.html">Balikpapan</a>
