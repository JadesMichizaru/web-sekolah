...
$name_err = $position_err = $status_err = "";
...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($name_err) && empty($positon_err) && empty($status_err)){
        // Prepare an update statement
        $sql = "UPDATE employees SET name=?, position=?, status=? WHERE id=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssi", $param_name, $param_position, $param_status, $param_id);
